...
public class CriptomonedasMenu extends Menu implements Clickleable{
    ...
    private void buidlInv(HashMap<String, String> pag1){
        buildPag1();
        ...
        Bukkit.getScheduler().scheduleAsyncDelayedTask(Pixelcoin.getInstance(), () -> {
            ...
            for (ItemStack actual : inventory.getContents()) {
                ...
                try {
                    ...
                    precio.add(1, ChatColor.GOLD + "Precio/Moneda:" + ChatColor.GREEN + " " + precioMoneda + " $");
    ...
    private void buildPag1(){
        pag1.put("BTCUSD", "Bitcoin");
        pag1.put("ETHUSD", "Ethereum");
        pag1.put("LTCUSD", "Litecoin");
    }
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        if(itemStack == null || !itemStack.getType().toString().equalsIgnoreCase("GOLD_BLOCK")){
            return;
        }
        ...
        closeMenu();
        ComprarBolsaSolicitud comprarAccionSolicitud1 = new ComprarBolsaSolicitud(simbolo, PosicionesAbiertas.TIPOS.CRIPTOMONEDAS.toString(), "monedas", player.getName(), precio);
