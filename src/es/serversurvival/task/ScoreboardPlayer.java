...
public class ScoreboardPlayer extends BukkitRunnable {
    ...
    private Scoreboard createScoreboardStats(String jugador) {
        ...
        Score score1 = objective.getScore(ChatColor.GOLD + "Tus pixelcoins: " + ChatColor.GREEN + formatea.format(dineroJugador) + " PC");
        score1.setScore(1);
    ...
    private Scoreboard createScoreboardTopPlayers() {
        ...
        try {
            j.conectar();
            ArrayList<String> jugadores = j.getTop3PlayersPixelcoins();
            ...
            for (String jugador : jugadores) {
                pixelcoins = j.getDinero(jugador);
                mensaje = ChatColor.GOLD + "" + pos + ": " + jugador + ChatColor.GREEN + " " + formatea.format(pixelcoins) + " PC";
