package es.serversurvival.empresas.empresas._shared;
...
public final class EmpresasServiceTets {
    ...
    public void getByOwner(){
        ...
        assertThat(this.empresasService.getByOwner("jaime")).hasSize(2);
        assertThat(this.empresasService.getByOwner("jaime")).hasSize(2);
    }
    ...
    public void getByNombre(){
        ...
        assertThat(this.empresasService.getByNombre(empresaToSave.getNombre())).isNotNull()
                .matches(empresa -> empresa.getNombre().equalsIgnoreCase(empresaToSave.getNombre()));
        assertThat(this.empresasService.getById(empresaToSave.getEmpresaId())).isNotNull()
                .matches(empresa -> empresa.getNombre().equalsIgnoreCase(empresaToSave.getNombre()));
