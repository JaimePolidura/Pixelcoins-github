...
import static es.serversurvival.empresas.empleados._shared.domain.TipoSueldo.*;
...
public final class ContratarUseCaseTest {
    ...
    public void shouldContratar(){
        ...
        this.useCase.contratar("jaime", "pedro", "empresa", 2, DIA, "trabajador");

        verify(this.empleadosService, times(1)).save(
                argThat(of("pedro")), argThat(of("empresa")), anyDouble(), argThat(of(DIA)), argThat(of("trabajador"))
        );
    ...
    public void employeeToHireNotAlreadyWorks(){
        ...
        assertThatCode(() -> this.useCase.contratar("jaime", "pedro", "empresa", 2, DIA, "trabajador"))
    ...
    public void correctFormatSueldo(){
        assertThatCode(() -> this.useCase.contratar("jaime", "pedro", "", 0, DIA, "trabajador"))
                .isInstanceOf(IllegalQuantity.class);

        assertThatCode(() -> this.useCase.contratar("jaime", "pedro", "", -1, DIA, "trabajador"))
                .isInstanceOf(IllegalQuantity.class);
    }
