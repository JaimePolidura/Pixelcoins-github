package es.serversurvival.v1.bolsa.posicionesabiertas.comprarcorto;
...
public final class ComprarCortoUseCaseTest {
    ...
    public void shouldComprarCortoPartial(){
        ...
        verify(this.eventBus, times(1)).publish(argThat(of(
                PosicionCompraCortoEvento.of("jaime", "AMZN", "Amazon", posicionAbierta.getPrecioApertura(),
                        posicionAbierta.getFechaApertura(), activoInfo.getPrecio(), posicionAbierta.getCantidad() - 1, TipoActivo.ACCIONES)
        )));
    }
    ...
    public void shouldComprarCortoTotal(){
        ...
        verify(this.eventBus, times(1)).publish(argThat(of(
                PosicionCompraCortoEvento.of("jaime", "AMZN", "Amazon", posicionAbierta.getPrecioApertura(),
                        posicionAbierta.getFechaApertura(), activoInfo.getPrecio(), posicionAbierta.getCantidad(), TipoActivo.ACCIONES)
        )));
    }
