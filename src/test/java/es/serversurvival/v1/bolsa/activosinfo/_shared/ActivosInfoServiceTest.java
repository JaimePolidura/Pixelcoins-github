package es.serversurvival.v1.bolsa.activosinfo._shared;

import es.serversurvival.v1._shared.cache.UnlimitedCacheSize;
...
import es.serversurvival.v1.bolsa.activosinfo._shared.domain.ActivoInfoRepository;
...
public final class ActivosInfoServiceTest {
    ...
    public void getByNombreActivo(){
        ...
        Assertions.assertThat(activoInfoAPICall.getNombreActivo()).isEqualTo("AMZN");
