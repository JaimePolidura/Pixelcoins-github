...
import es.serversurvival.v1.MockitoArgEqualsMatcher;
import es.serversurvival.v1.bolsa.activosinfo.DepencyContainerTipoActivoInfoMocks;
...
import static es.serversurvival.v1.bolsa.activosinfo.DepencyContainerTipoActivoInfoMocks.accionesApiService;
...
public final class OnPosicionAbiertaTest {
    ...
    public void onPosicionAbiertaNotExistsWithoutNombreActivoLargo(){
        ...
        verify(this.activoInfoService, times(1)).save(argThat(MockitoArgEqualsMatcher.of(
                new ActivoInfo("AMZN", 10, TipoActivo.ACCIONES, "tumadre")
        )));
    }
    ...
    public void onPosicionAbiertaNotExistsWithNombreActivoLargo(){
        ...
        verify(this.activoInfoService, times(1)).save(argThat(MockitoArgEqualsMatcher.of(
                new ActivoInfo("AMZN", 10, TipoActivo.ACCIONES, "Amazon")
        )));
    }
    ...
    private PosicionAbiertaEvento of(String nombreActivo, String nombreActivoLargo, double precioUnidad){
        return PosicionAbiertaEvento.of("jaime", nombreActivo, 1, precioUnidad, TipoActivo.ACCIONES,
                20, nombreActivoLargo, TipoPosicion.CORTO);
    }
}
