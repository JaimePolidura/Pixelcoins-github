package es.serversurvival.v1.empresas.accionistasserver._shared;
...
public final class AccionistasServerServiceTest {
    ...
    public void findByEmpresa(){
        ...
        Assertions.assertThat(this.service.findByEmpresa("empresa"))
                .hasSize(2)
    ...
    @Test
    public void save2(){
        this.service.save("jaime", TipoAccionista.EMPRESA, "empresa", 1, 1);
