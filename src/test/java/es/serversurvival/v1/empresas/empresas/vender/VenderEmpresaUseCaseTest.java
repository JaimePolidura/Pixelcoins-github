...
public final class VenderEmpresaUseCaseTest {
    ...
    public void shouldVenderWithCompradorEmployee(){
        ...
        Jugador vendedor = JugadoresTestMother.createJugador("vendedor", 100);
        Empleado empleado = EmpleadosTestMother.createEmpleado("comprador", "empresa");
    ...
    public void enoughPixelcoins(){
        ...
        when(this.jugadoresService.getByNombre("vendedor")).thenReturn(JugadoresTestMother.createJugador("vendedor", 100));
        when(this.jugadoresService.getByNombre("comprador")).thenReturn(JugadoresTestMother.createJugador("comprador", 1));
