...
public final class DepositarPixelcoinsEmpresaTest {
    ...
    public void shouldMakeDeposit(){
        ...
        Jugador jugadorDepositador = JugadoresTestMother.createJugador("jaime", 10);
    ...
    public void ownerOfEmpresa(){
        when(this.jugadoresService.getByNombre("jaime")).thenReturn(JugadoresTestMother.createJugador("jaime", 10));
