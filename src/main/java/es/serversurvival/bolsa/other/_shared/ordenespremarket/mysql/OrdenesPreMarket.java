package es.serversurvival.bolsa.other._shared.ordenespremarket.mysql;
...
public final class OrdenesPreMarket extends MySQLRepository {
    ...
    public void nuevaOrden (String jugador, String nombre_activo, int cantidad, TipoAccion accion_orden, int id_posicionabierta) {
