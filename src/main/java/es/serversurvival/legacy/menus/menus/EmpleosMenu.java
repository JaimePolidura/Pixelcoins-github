...
import es.serversurvival.legacy.menus.inventoryFactory.inventories.EmpleosInventoryFactory;
...
public class EmpleosMenu extends Menu implements Clickable, Refreshcable, CanGoBack {
    ...
    public void onOherClick(InventoryClickEvent event) {
        ...
        AllMySQLTablesInstances.empleadosMySQL.irseEmpresa(nombreEmpresa, (Player) event.getWhoClicked());
        refresh();
