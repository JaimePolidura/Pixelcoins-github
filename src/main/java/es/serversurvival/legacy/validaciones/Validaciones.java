package es.serversurvival.legacy.validaciones;

import es.serversurvival.legacy.validaciones.misValidaciones.*;
...
public final class Validaciones {
    ...
    public final static es.serversurvival.legacy.validaciones.misValidaciones.JugadorRegistrado JugadorRegistrado = new JugadorRegistrado("Jugador no encontrado");
    public final static ItemNotBaneadoTienda ItemNotBaneadoTienda = new ItemNotBaneadoTienda("Item no permitido en la tienda");
    public final static es.serversurvival.legacy.validaciones.misValidaciones.NoHaSidoCompradoItem NoHaSidoCompradoItem = new NoHaSidoCompradoItem("No puedes revender un item que ya has comprado");
    public final static es.serversurvival.legacy.validaciones.misValidaciones.SuficientesEspaciosTienda SuficientesEspaciosTienda = new SuficientesEspaciosTienda("Tienes muchos objetos en la tineda");
    public final static JugadorOnline JugadorOnline = new JugadorOnline("Ese jugador no esta online");
    public final static es.serversurvival.legacy.validaciones.misValidaciones.InventarioNoLleno InventarioNoLleno = new InventarioNoLleno("No puedes tener el inventario lleno");
