...
public final class PerfileMenu extends Menu {
    ...
    public PerfileMenu(String jugadorNombre) {
    ...
    private ItemStack buildItemWeb() {
        ...
        CuentaWeb cuenta = this.cuentasWebService.getByUsername(jugador.getNombre());
        if(cuenta == null){
