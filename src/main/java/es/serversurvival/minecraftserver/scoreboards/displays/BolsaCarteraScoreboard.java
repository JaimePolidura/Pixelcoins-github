...
public class BolsaCarteraScoreboard implements ServerScoreboardCreator {
    ...
    public Scoreboard create(Player player) {
        Scoreboard scoreboard = MinecraftUtils.createScoreboard("bolsa", ChatColor.GOLD + "" + ChatColor.BOLD + "TUS MEJORES ACCIONES");
        ...
        for(Map.Entry<PosicionAbierta, Double> entry : posicionAbiertas.entrySet()){
            ...
            MinecraftUtils.addLineToScoreboard(objective, linea, pos);

            pos--;
            loops++;
        }

        MinecraftUtils.addLineToScoreboard(objective, ChatColor.GOLD + "       ", -10);
        MinecraftUtils.addLineToScoreboard(objective, ChatColor.GOLD + "--------------------------", -20);
        MinecraftUtils.addLineToScoreboard(objective, ChatColor.GOLD + "Para invertir /bosla valores", -30);
        MinecraftUtils.addLineToScoreboard(objective, ChatColor.GOLD + "Tus cantidad /bolsa cartera", -40);
