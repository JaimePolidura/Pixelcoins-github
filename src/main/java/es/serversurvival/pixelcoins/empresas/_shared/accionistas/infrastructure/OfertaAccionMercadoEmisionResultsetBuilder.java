...
@Component
public final class OfertaAccionMercadoEmisionResultsetBuilder implements ResultsetObjetBuilder<OfertaAccionMercadoEmision> {
    @Override
    public OfertaAccionMercadoEmision build(ResultSet rs) throws SQLException {
        return new OfertaAccionMercadoEmision(
