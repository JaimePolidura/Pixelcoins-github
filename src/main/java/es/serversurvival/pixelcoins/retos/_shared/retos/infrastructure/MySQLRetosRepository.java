...
public final class MySQLRetosRepository extends Repository<Reto, Integer, Object> implements RetosRepository {
    ...
    @Override
    public List<Reto> findByRetoLineaPadre(UUID retoPadreProgresionId) {
        return super.buildListFromQuery(Select.from(TABLE_NAME).where("retoPadreProgresionId").equal(retoPadreProgresionId));
    }
