...
public enum TipoTransaccion {
    JUGADORES_PAGO                   (cuentaAfectadaPagador(EFECTIVO, EFECTIVO),          cuentaAfectadaPagado(EFECTIVO, EFECTIVO)),
    JUGADORES_CAMBIO_INGRESAR_ITEM   (cuentaAfectadaPagador(EFECTIVO, EFECTIVO),          cuentaAfectadaPagado(EFECTIVO, EFECTIVO)),
    JUGADORES_CAMBIO_SACAR_ITEM      (cuentaAfectadaPagador(EFECTIVO, EFECTIVO),          cuentaAfectadaPagado(EFECTIVO, EFECTIVO)),
    JUGADORES_CAMBIO_SACAR_MAX_ITEM  (cuentaAfectadaPagador(EFECTIVO, EFECTIVO),          cuentaAfectadaPagado(EFECTIVO, EFECTIVO)),

    DEUDAS_PRIMER_DESEMBOLSO         (cuentaAfectadaPagador(DEUDA_ACREDOR, EFECTIVO),     cuentaAfectadaPagado(EFECTIVO, DEUDA_DEUDOR)),
    DEUDAS_CUOTA                     (cuentaAfectadaPagador(EFECTIVO, DEUDA_ACREDOR),     cuentaAfectadaPagado(DEUDA_DEUDOR, EFECTIVO)),
    DEUDAS_PAGO_COMPLETO             (cuentaAfectadaPagador(EFECTIVO, DEUDA_ACREDOR),     cuentaAfectadaPagado(DEUDA_DEUDOR, EFECTIVO)),
