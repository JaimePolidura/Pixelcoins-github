...
@Command(value = "empresas miempresa", isSubCommand = true, args = {"empresa"})
public class MiEmpresaComandoExecutor extends PixelcoinCommand implements CommandRunnerArgs<MiEmpresaComando> {
