...
@Command(value = "empresas editarnombre", isSubCommand = true, args = {"empresa", "nuevoNombre"})
public class EditarNombreComandoExecutor extends PixelcoinCommand implements CommandRunnerArgs<EditarNombreComando> {
