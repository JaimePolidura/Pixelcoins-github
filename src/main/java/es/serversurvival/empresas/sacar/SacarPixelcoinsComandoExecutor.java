...
@Command(value = "empresas sacar", isSubCommand = true, args = {"empresa", "pixelcoins"})
public class SacarPixelcoinsComandoExecutor extends PixelcoinCommand implements CommandRunnerArgs<SacarPixelcoinsComando> {
