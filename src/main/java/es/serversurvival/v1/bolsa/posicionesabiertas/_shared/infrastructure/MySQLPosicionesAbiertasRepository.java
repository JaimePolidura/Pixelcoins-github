package es.serversurvival.v1.bolsa.posicionesabiertas._shared.infrastructure;
...
public final class MySQLPosicionesAbiertasRepository extends DataBaseRepository<PosicionAbierta, UUID> implements PosicionesAbiertasRepository {
    ...
    public List<PosicionAbierta> findByNombreActivo(String nombreActivo) {
        return buildListFromQuery(Select.from(TABLE_NAME).where("nombreActivo").equal(nombreActivo));
    }
